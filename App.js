...
this.setState({
  ...
  handlesubmit = event => {
    ...
    alert( "error Price Value  should be lesser than Price on scale ");
      }
    }
        ...
        <div className='row mt-5 m-5 mg-3'>
          ...
          <div className='col-md-8'>
            <form className='form-group' onSubmit={this.handlesubmit}>
              ...
              <Select options={options}value={this.Categories} className=" w-75" placeholder="sound" onClick={this.handleCategorieschange} />
              ...
              <button className='btn btn-dark create-btn ' onClick={this.handlesubmit}>CREATE CONTRACT</button>
            </form>
          </div>
